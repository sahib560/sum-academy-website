...
| GET | `/api/payments/config` | Yes | `{}` | `{"success":true,"message":"Payment config fetched","data":{"jazzcash":{"enabled":true,"merchantId":"JZ123","password":"secret","integritySalt":"salt123","accountTitle":"SUM Academy","instructions":"Send payment to JazzCash merchant and upload the transaction receipt.","sandboxUrl":"https://sandbox.jazzcash.com.pk/ApplicationAPI/API/2.0/Generate/GenerateTransactionID","productionUrl":"https://payments.jazzcash.com.pk/ApplicationAPI/API/2.0/Generate/GenerateTransactionID","returnUrl":"https://yourclient.app/payment/callback/jazzcash"},"easypaisa":{"enabled":true,"accountNumber":"03001234567","password":"secret","accountTitle":"SUM Academy","username":"sumuser","instructions":"Send payment to EasyPaisa account and upload the transaction receipt.","sandboxUrl":"https://easypaisa.com.pk/easypaisaPayment/v2/Login","productionUrl":"https://easypaisa.com.pk/easypaisaPayment/v2/Login","returnUrl":"https://yourclient.app/payment/callback/easypaisa"},"bankTransfer":{"enabled":true,"bankName":"Meezan Bank","accountTitle":"SUM Academy","accountNumber":"1234567890","iban":"PK12ABCD1234567890"}}}` | `{"success":false,"message":"Failed to fetch config","error":"Failed to fetch config"}` |
...
| GET | `/api/payments/config` | `{}` | `{"success":true,"message":"Payment config fetched","data":{"jazzcash":{"enabled":true,"merchantId":"JZ123","password":"secret","integritySalt":"salt123","accountTitle":"SUM Academy","instructions":"Send payment to JazzCash merchant and upload the transaction receipt.","sandboxUrl":"https://sandbox.jazzcash.com.pk/ApplicationAPI/API/2.0/Generate/GenerateTransactionID","productionUrl":"https://payments.jazzcash.com.pk/ApplicationAPI/API/2.0/Generate/GenerateTransactionID","returnUrl":"https://yourclient.app/payment/callback/jazzcash"},"easypaisa":{"enabled":true,"accountNumber":"03001234567","password":"secret","accountTitle":"SUM Academy","username":"sumuser","instructions":"Send payment to EasyPaisa account and upload the transaction receipt.","sandboxUrl":"https://easypaisa.com.pk/easypaisaPayment/v2/Login","productionUrl":"https://easypaisa.com.pk/easypaisaPayment/v2/Login","returnUrl":"https://yourclient.app/payment/callback/easypaisa"},"bankTransfer":{"enabled":true,"bankName":"Meezan Bank","accountTitle":"SUM Academy","accountNumber":"1234567890","iban":"PK12ABCD1234567890"}}}` | `{"success":false,"message":"Failed to fetch payment config","error":"Failed to fetch payment config"}` |
