...
function Footer() {
  ...
  const footerContent = settings.content || {};
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              {[
                {
                  label: "Facebook",
                  to: footerContent.facebookUrl || "/facebook",
                  icon: (
                ...
                {
                  label: "WhatsApp",
                  to: footerContent.whatsappUrl || "/whatsapp",
                  icon: (
                    <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
                ...
                {
                  label: "TikTok",
                  to: footerContent.tiktokUrl || "/tiktok",
                  icon: (
                    <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-300">
              Call: {settings.general.contactPhone || "+92 300 123 4567"}
            </p>
          </div>
