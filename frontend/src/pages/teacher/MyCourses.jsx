    ...
    try {
      ...
      await saveLectureContentMutation.mutateAsync({
        ...
        data: {
          ...
          isLiveSession: Boolean(selectedVideo.isLiveSession),
          videoMode:
